...
public class HashTableTester {
    ...
    public static void main(String[] args) {
        ...
        Tweet testTweety = tweetTable.get("2020-03-04 15:34:47");
        System.out.println("testTweet0: \t" + testTweet0);
        System.out.println("testTweety: \t" + testTweety);
        ...
        ArrayList<Tweet> values = tweetTable.values();
        ...
        ArrayList<String> keys = MyHashTable.slowSort(tweetTable);
        for (String key : keys) {
        	System.out.println(key);
        	System.out.println(tweetTable.get(key));
        }
        
        // MY ADDED TEST
        System.out.println("\n---------------\nTesting fastSort:\n---------------\n");
        
        ArrayList<String> keyies = MyHashTable.fastSort(tweetTable);
        for (String key : keyies) {
        	System.out.println(key);
        	System.out.println(tweetTable.get(key));
        }
       ...
       // ArrayList<String> stopWords = new ArrayList<String>();
        ...
        stopWords.add("LOL");
        stopWords.add("a");
        stopWords.add("abracadabraboomshakaloom");
        ...
        */
        ...
        Tweet tweety = new Tweet("USER_EmaJova","2020-04-29 16:33:56","@USER_lolypoo I AM SUPERIOR.");
        t.addTweet(tweety);
        System.out.println("Tweet by USER_EmaJova added!");
        
        Tweet tweetyy = new Tweet("USER_EmaJova","2020-04-29 10:33:56","@quarantine Bruh");
        t.addTweet(tweetyy);
        System.out.println("Another Tweet by USER_EmaJova added!");
        
        Tweet tweetyyy = new Tweet("USER_EmaJova","2021-03-29 17:33:56","@jillyBae u r so CUTE");
        t.addTweet(tweetyyy);
        System.out.println("Yet another Tweet by USER_EmaJova added!");
        
        
        System.out.println("\n---------------\nTesting latestTweetByAuthor:\n---------------\n");
        Tweet tweetByAuthor = t.latestTweetByAuthor("USER_989b85bb");
        Tweet tweetByAuthor2 = t.latestTweetByAuthor("USER_EmaJova"); 
        if (tweetByAuthor == null || !tweetByAuthor.getAuthor().equals("USER_989b85bb") || 
        	...
        	errors.append("Failed to retrieve the latest tweet by USER_989b85bb\n");
        }
        System.out.println("Latest tweet by USER_989b85bb :" + tweetByAuthor);
        System.out.println("Latest tweet by USER_EmaJova :" + tweetByAuthor2);
        ...
        //System.out.println(tweetsByDate);
        	...
        	System.out.println("null - no tweets for this date");
        }
        
        
        // MY ADDED TEST
        System.out.println("\n---------------\nTesting trendingTopics:\n---------------\n");
        //ArrayList<String> stopwords = new ArrayList<String>();
        
        
        
        ArrayList<String> printWords = t.trendingTopics();
        System.out.println(printWords);
        System.out.println(printWords.size());
